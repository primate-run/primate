...
<div style="max-width: 800px; margin: 2rem auto; padding: 0 1rem;">
  <h1>About Us</h1>
  <p>
    Welcome to our Primate Svelte demo application. This page demonstrates how
    to manage document head elements including the title and meta tags for
  ...
  <p>
    ...
    with Primate and Svelte. Our goal is to make full-stack development easier
    and more efficient.
  </p>
