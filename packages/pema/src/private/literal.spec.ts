...
test.case("default", assert => {
  const d = p.literal("foo").default("foo");
...
test.case("optional", assert => {
  const o = p.literal("foo").optional();
